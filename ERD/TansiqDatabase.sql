--------------------------------------------------------
--  File created - Friday-February-01-2019   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (3,26);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (4,28);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (3,25);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (8,28);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (9,35);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (4,27);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (5,29);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (6,30);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (7,31);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (8,32);
Insert into HR.DEP_PREREQ (DEP_ID,PREREQ_ID) values (9,36);
REM INSERTING into HR.DEPARTMENT
SET DEFINE OFF;
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (1,'CSE',5,10,null);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (2,'CIVIL',10,15,null);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (3,'testDep2',200,250,1200);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (8,'test55',100,150,12500);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (9,'test44',50,55,1200);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (4,'test3',60,65,500);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (5,'test55',1,20,150);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (6,'blabal',12,22,500);
Insert into HR.DEPARTMENT (ID,NAME,MIN_CAP,MAX_CAP,MIN_MARK) values (7,'test4',500,550,950);
REM INSERTING into HR.EDU_LEVEL
SET DEFINE OFF;
Insert into HR.EDU_LEVEL (ID,FACULTY,YEAR) values (1,'ENGINEERING',1);
Insert into HR.EDU_LEVEL (ID,FACULTY,YEAR) values (2,'ENGINEERING',1);
Insert into HR.EDU_LEVEL (ID,FACULTY,YEAR) values (3,'ENGINEERING',2);
Insert into HR.EDU_LEVEL (ID,FACULTY,YEAR) values (4,'ENGINEERING',1);
...
SET DEFINE OFF;
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,21,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (2,22,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,23,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (2,24,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (2,26,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,33,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,25,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (2,34,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,35,100);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (2,36,150);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,27,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (2,28,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,29,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,30,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,31,0);
Insert into HR.PREREQUISITE (SUBJECT,ID,MIN_MARK_SUBJECT) values (1,32,0);
...
SET DEFINE OFF;
Insert into HR.SUBJECT (ID,NAME,EDU_LEVEL_ID) values (1,'programming',1);
Insert into HR.SUBJECT (ID,NAME,EDU_LEVEL_ID) values (2,'math',2);
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Trigger DEPARTMENT_TRG1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HR"."DEPARTMENT_TRG1" 
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID IS NULL THEN
      SELECT DEPARTMENT_SEQ1.NEXTVAL INTO :NEW.ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "HR"."DEPARTMENT_TRG1" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."SUBJECT" MODIFY ("EDU_LEVEL_ID" NOT NULL ENABLE);
--------------------------------------------------------
